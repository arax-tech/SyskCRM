        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/common/student/store') }}" enctype="multipart/form-data">
                            @csrf
                                            ...
                                            <div id="smartwizard" class="form-wizard order-create">
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-lg-3 mb-2">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="date" name="passport_expiry_date" value="{{ old('passport_expiry_date') }}" class="form-control">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 mb-2">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" name="contact_number_code" value="{{ old('contact_number_code') }}" class="form-control w-25" placeholder="+91">
                                                                    <input type="text" name="contact_number" value="{{ old('contact_number') }}" class="form-control w-75" placeholder="1234567">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <h4>
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                ...
                                                                <div class="form-check form-switch float-right">
                                                                    <label for="SamePermanentAddress" style="font-weight: normal !important;">Same as Above</label>
                                                ...
                                                <div id="previous_qualification" class="tab-pane" role="tabpanel">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="mb-3">
                                                                <label class="text-label form-label">Student Route <span class="text-danger">*</span></label>
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="col-lg-6 mb-2">
                                                                <div class="mb-3">
                                                                    <label class="text-label form-label">Student Finance</label>
                                                                    <input type="text" name="student_finance" value="{{ old('student_finance') }}" class="form-control">
                                                                </div>
                                                            </div>

                                                            <div class="col-lg-6 mb-2">
                                                                <div class="mb-3">
                                                                    <label class="text-label form-label">CNR No</label>
                                                                    <input type="number" name="cnr_no" value="{{ old('cnr_no') }}" class="form-control">
                                                                </div>
                                                            </div>
                                                        @endif
...
<script>
    $(document).ready(function(){
        ...
        $('#proof_of_address_type_input').hide();
        $('select[name="proof_of_address_type"]').on('change', function(){
            if(this.value == "Other"){
                $('#proof_of_address_type_select').hide();
                $('#proof_of_address_type_input').show();
            }else{
                $('#proof_of_address_type_input').hide();
            }
        });
