                                ...
                                <div class="col-lg-4 mb-2">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" name="password" id="PasswordInput" class="form-control w-75" data-bs-toggle="tooltip" data-bs-placement="top" title="If you want to update password then enter new password othereise leave this field blank...">
                                ...
                                <div class="col-lg-4 mb-2">
                                    <div class="mb-3">
                                        ...
                                        <select name="designation" class="form-control" required="">
                                            ...
                                            @if ($staff->designation == "Student Counsellor")
                                                selected 
                                            @endif
                                            >Student Counsellor</option>
                                            ...
                                            @if ($staff->designation == "Super Admin")
                                                selected 
                                            @endif
                                            >Super Admin</option>
                                        </select>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateValidation" class="custom_label">Update Validation</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateValidation" @if (in_array("StudentUpdateValidation", $permission)) checked  @endif value="StudentUpdateValidation">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateInfo" class="custom_label">Update Other Info</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateInfo" @if (in_array("StudentUpdateInfo", $permission)) checked  @endif value="StudentUpdateInfo">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentAddInterviewAndTraning" class="custom_label">Add Traning / Interview</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentAddInterviewAndTraning" @if (in_array("StudentAddInterviewAndTraning", $permission)) checked  @endif value="StudentAddInterviewAndTraning">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateInterviewPreparation" class="custom_label">Update Interview Preparation</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateInterviewPreparation" @if (in_array("StudentUpdateInterviewPreparation", $permission)) checked  @endif value="StudentUpdateInterviewPreparation">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdatePreCASofferInterview" class="custom_label">Update Pre CAS offer Interview</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdatePreCASofferInterview" @if (in_array("StudentUpdatePreCASofferInterview", $permission)) checked  @endif value="StudentUpdatePreCASofferInterview">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateInterviewTraning" class="custom_label">Update Interview Traning</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateInterviewTraning" @if (in_array("StudentUpdateInterviewTraning", $permission)) checked  @endif value="StudentUpdateInterviewTraning">
                                                    </div>
                                                </p>
                                                ...
                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateVisaDetail" class="custom_label">Update Visa Detail</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateVisaDetail" @if (in_array("StudentUpdateVisaDetail", $permission)) checked  @endif value="StudentUpdateVisaDetail">
                                                    </div>
                                                </p>
                                                ...
                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateSettlementDetail" class="custom_label">Update Settlement Detail</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateSettlementDetail" @if (in_array("StudentUpdateSettlementDetail", $permission)) checked  @endif value="StudentUpdateSettlementDetail">
                                                    </div>
                                                </p>
                                                ...
                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateSFEDetail" class="custom_label">Update SFE Detail</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateSFEDetail" @if (in_array("StudentUpdateSFEDetail", $permission)) checked  @endif value="StudentUpdateSFEDetail">
                                                    </div>
                                                </p>

                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateInternalTraning" class="custom_label">Update Internal Traning</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateInternalTraning" @if (in_array("StudentUpdateInternalTraning", $permission)) checked  @endif value="StudentUpdateInternalTraning">
                                                    </div>
                                                </p>
                                                ...
                                                <p>
                                                    <div class="form-check form-switch">
                                                        <label for="StudentUpdateFee" class="custom_label">Update Fee</label>
                                                        <input type="checkbox" class="form-check-input" name="permissions[]" id="StudentUpdateFee" @if (in_array("StudentUpdateFee", $permission)) checked  @endif value="StudentUpdateFee">
                                                    </div>
                                                </p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="CommissionCreate" value="CommissionCreate"  @if (in_array("CommissionCreate", $permission)) checked  @endif>
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="CommissionUpdate" value="CommissionUpdate"  @if (in_array("CommissionUpdate", $permission)) checked  @endif>
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="CommissionDelete" value="CommissionDelete"  @if (in_array("CommissionDelete", $permission)) checked  @endif>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="ReportView" @if (in_array("ReportView", $permission)) checked  @endif value="ReportView">
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="StateCityView" @if (in_array("StateCityView", $permission)) checked  @endif value="StateCityView">
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="StateCityCreate" @if (in_array("StateCityCreate", $permission)) checked  @endif value="StateCityCreate">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="StateCityUpdate" @if (in_array("StateCityUpdate", $permission)) checked  @endif value="StateCityUpdate">
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="StateCityDelete" @if (in_array("StateCityDelete", $permission)) checked  @endif value="StateCityDelete">
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="NoticeView" @if (in_array("NoticeView", $permission)) checked  @endif value="NoticeView">
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="NoticeCreate" @if (in_array("NoticeCreate", $permission)) checked  @endif value="NoticeCreate">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="NoticeUpdate" @if (in_array("NoticeUpdate", $permission)) checked  @endif value="NoticeUpdate">
                                                </div>
                                            </td>

                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="NoticeDelete" @if (in_array("NoticeDelete", $permission)) checked  @endif value="NoticeDelete">
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="SettingView" @if (in_array("SettingView", $permission)) checked  @endif value="SettingView">
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="permissions[]" id="SettingUpdate" @if (in_array("SettingUpdate", $permission)) checked  @endif value="SettingUpdate">
                                                </div>
                                            </td>
