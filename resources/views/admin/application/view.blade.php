            ...
            <div class="col-xl-12 col-lg-12 col-sm-12">
                <div class="card">
                    <div class="card-header bg-light">
                        ...
                        <a class="btn btn-sm btn-primary float-right" href="{{ url('admin/application/') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4 ">
                            <div class="col-md-3">
                                <a target="_blank" href="{{ url('admin/student/view/'.$student->id) }}" class="btn btn-primary">View Student</a>
                            </div>


                            <div class="col-md-3">
                                <a target="_blank" href="{{ url('admin/course/view/'.$course->id) }}" class="btn btn-primary">View Course</a>
                            </div>

                            <div class="col-md-3">
                                <a target="_blank" href="{{ url('admin/campus/view/'.$campus->id) }}" class="btn btn-primary">View Course</a>
                            </div>

                            <div class="col-md-3">
                                <a target="_blank" href="{{ url('admin/university/view/'.$university->id) }}" class="btn btn-primary">View University</a>
                            </div>
