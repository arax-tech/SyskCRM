...
class StudentController extends Controller
{
    ...
    {
        return view('admin.student.type');
    }
    ...
    public function store (Request $request)
    {
        ...
        return redirect('/admin/student')->with('flash_message_success', 'Student Create Successfully...');
    }
    ...
    public function update (Request $request, $id)
    {
        ...
        return redirect('/admin/student')->with('flash_message_success', 'Student Update Successfully...');
    }
